...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function qo(e,t,n){let r=new Float32Array(No),i=new W(0,1,0);return new xa({name:`SphericalGaussianBlur`,defines:{n:No,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Xo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Jo(){return new xa({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Xo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Yo(){return new xa({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Xo(),fragmentShader:`
	...
	`}var Zo=class extends Bn{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new sa(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`,ou={origin:[`#1b2a6b`,`#5ff7d8`],depth:[`#16215c`,`#5ff7d8`],mono:[`#0a1626`,`#35e0d0`],mix:[`#243a7d`,`#7ff9e2`]},su={origin:0,depth:1,mono:2,mix:3};function cu(e){let t=new Float32Array(e*3);for(let n=0;n<e;n++){let e=Math.random()*2-1,r=Math.random()*Math.PI*2,i=Math.sqrt(1-e*e),a=2.6+Math.random()*1.9,o=n*3;t[o]=i*Math.cos(r)*a,t[o+1]=i*Math.sin(r)*a,t[o+2]=e*a}return t}function lu(e){let t=new Float32Array(e);for(let n=0;n<e;n++)t[n]=Math.random();return t}var uu=class{object=null;geometry=null;material=null;count=0;#e=0;#t=0;constructor(){this.material=new xa({vertexShader:iu,fragmentShader:au,transparent:!0,depthWrite:!1,depthTest:!0,uniforms:{uTime:{value:0},uProgress:{value:0},uSize:{value:1.6},uSizeScale:{value:3.4},uPixelRatio:{value:1},uNoiseAmp:{value:.012},uNoiseFreq:{value:1.6},uMouse:{value:new W(1e9,1e9,1e9)},uRepelRadius:{value:.45},uRepelStrength:{value:.22},uTint:{value:0},uTintA:{value:new q(`#1b2a6b`)},uTintB:{value:new q(`#5ff7d8`)},uOpacity:{value:.95},uSoftness:{value:.18},uSolid:{value:0},uLight:{value:.85},uAmbient:{value:.32},uSpecular:{value:.25},uAOStrength:{value:.8},uHasNormals:{value:0}}})}build(e){this.geometry?.dispose();let t=new yi;t.setAttribute(`position`,new ii(e.positions,3)),t.setAttribute(`color`,new ii(e.colors,3)),t.setAttribute(`aDepth`,new ii(e.depths,1)),t.setAttribute(`aScatter`,new ii(cu(e.count),3)),t.setAttribute(`aSeed`,new ii(lu(e.count),1));let n=!!e.normals;return t.setAttribute(`aNormal`,new ii(e.normals??new Float32Array(e.count*3),3)),t.setAttribute(`aAO`,new ii(e.ao??new Float32Array(e.count).fill(1),1)),this.material.uniforms.uHasNormals.value=+!!n,t.boundingSphere=new di(new W(0,0,0),3.2),this.geometry=t,this.count=e.count,this.object?this.object.geometry=t:(this.object=new aa(t,this.material),this.object.frustumCulled=!1),this.object}applyParams(e){let t=this.material.uniforms;t.uSize.value=e.pointSize,t.uOpacity.value=e.opacity,t.uSoftness.value=e.softness,t.uNoiseAmp.value=e.noiseAmp,t.uNoiseFreq.value=e.noiseFreq,t.uRepelRadius.value=e.repelRadius,t.uRepelStrength.value=e.repelStrength,t.uLight.value=e.light??.85,t.uAmbient.value=e.ambient??.32,t.uSpecular.value=e.specular??.25,t.uAOStrength.value=e.aoStrength??.8;let n=+!!e.solidMode;t.uSolid.value=n,this.material.depthWrite=!!e.solidMode,this.material.transparent=!e.solidMode;let r=e.tint??`origin`;t.uTint.value=su[r]??0;let i=ou[r]??ou.origin;t.uTintA.value.set(i[0]),t.uTintB.value.set(i[1]),this.material.needsUpdate=!0}setPixelRatio(e){this.material.uniforms.uPixelRatio.value=e}setMouse(e){this.material.uniforms.uMouse.value.copy(e)}clearMouse(){this.material.uniforms.uMouse.value.set(1e9,1e9,1e9)}replay(){this.#e=0,this.#t=1}snapToEnd(){this.#e=1,this.#t=1,this.material.uniforms.uProgress.value=1}update(e,t){let n=this.material.uniforms;n.uTime.value=e,this.#e<this.#t&&(this.#e=Math.min(this.#t,this.#e+t/1.6),n.uProgress.value=this.#e)}dispose(){this.geometry?.dispose(),this.material?.dispose(),this.geometry=null,this.object=null}},du=class e{static CAM_DIST=3.4;constructor(t){this.canvas=t,this.renderer=new Fl({canvas:t,antialias:!0,alpha:!0,preserveDrawingBuffer:!0,powerPreference:`high-performance`}),this.renderer.setClearColor(0,0),this.scene=new Tr,this.camera=new Ka(50,1,.01,100),this.camera.position.set(0,0,e.CAM_DIST),this.controls=new Gl(this.camera,t),this.controls.enableDamping=!0,this.controls.dampingFactor=.08,this.controls.rotateSpeed=.65,this.controls.zoomSpeed=.8,this.controls.minDistance=.6,this.controls.maxDistance=14,this.controls.autoRotateSpeed=.7,this.cloud=new uu,this.clock=new ho,this.raycaster=new fo,this.pointer=new U,this.mouseWorld=new W,this.plane=new Yi,this.camDir=new W,this.hasPointer=!1,this.fps=0,this.#e=0,this.#t=0,this.onFps=null,this.#r(),this.resize(),this.#a()}#e=0;#t=0;#n=0;#r(){this._onResize=()=>this.resize(),window.addEventListener(`resize`,this._onResize),this._onPointerMove=e=>{let t=this.canvas.getBoundingClientRect();this.pointer.x=(e.clientX-t.left)/t.width*2-1,this.pointer.y=-((e.clientY-t.top)/t.height)*2+1,this.hasPointer=!0},this._onPointerLeave=()=>{this.hasPointer=!1,this.cloud.clearMouse()},this.canvas.addEventListener(`pointermove`,this._onPointerMove),this.canvas.addEventListener(`pointerleave`,this._onPointerLeave)}resize(){let t=this.canvas.clientWidth||window.innerWidth,n=this.canvas.clientHeight||window.innerHeight,r=Math.min(window.devicePixelRatio||1,2);this.renderer.setPixelRatio(r),this.renderer.setSize(t,n,!1),this.camera.aspect=t/n,this.camera.updateProjectionMatrix(),this.cloud.setPixelRatio(r),this.cloud.material.uniforms.uSizeScale.value=e.CAM_DIST}setCloud(e){let t=this.cloud.build(e);t.parent||this.scene.add(t)}applyParams(e){this.cloud.applyParams(e),this.controls.autoRotate=!!e.autoRotate}resetView(){this.camera.position.set(0,0,e.CAM_DIST),this.controls.target.set(0,0,0),this.controls.update()}replay(){this.cloud.replay()}#i(){if(!this.hasPointer||this.cloud.material.uniforms.uRepelRadius.value<=0){this.cloud.clearMouse();return}this.camera.getWorldDirection(this.camDir),this.plane.setFromNormalAndCoplanarPoint(this.camDir,this.controls.target),this.raycaster.setFromCamera(this.pointer,this.camera),this.raycaster.ray.intersectPlane(this.plane,this.mouseWorld)&&this.cloud.setMouse(this.mouseWorld)}#a=()=>{this.#n=requestAnimationFrame(this.#a);let e=Math.min(this.clock.getDelta(),.1),t=this.clock.elapsedTime;this.controls.update(),this.#i(),this.cloud.update(t,e),this.renderer.render(this.scene,this.camera),this.#e++,t-this.#t>=.5&&(this.fps=Math.round(this.#e/(t-this.#t)),this.#e=0,this.#t=t,this.onFps?.(this.fps))};snapshot(){return this.renderer.render(this.scene,this.camera),new Promise(e=>{this.canvas.toBlob(t=>e(t),`image/png`)})}dispose(){cancelAnimationFrame(this.#n),window.removeEventListener(`resize`,this._onResize),this.canvas.removeEventListener(`pointermove`,this._onPointerMove),this.canvas.removeEventListener(`pointerleave`,this._onPointerLeave),this.controls.dispose(),this.cloud.dispose(),this.renderer.dispose()}};function fu(e,t,n){let r=document.createElement(e);return t&&(r.className=t),n!=null&&(r.textContent=n),r}function pu(e){let t=Number(e.min),n=Number(e.max),r=(Number(e.value)-t)/(n-t)*100;e.style.setProperty(`--pct`,`${r}%`)}function mu(e,t,n,r){e.innerHTML=``;let i=new Map,a=new Map;for(let o of t){let t=fu(`section`,`group`);t.appendChild(fu(`h3`,`group__title`,o.group));for(let e of o.items){let o=s.has(e.key),c=fu(`div`,`row`);if(e.type===`range`){let t=fu(`div`,`row__head`);t.appendChild(fu(`label`,`row__label`,e.label));let s=fu(`span`,`row__val`);t.appendChild(s),c.appendChild(t);let l=fu(`input`);l.type=`range`,l.min=e.min,l.max=e.max,l.step=e.step,l.value=n[e.key];let u=t=>{s.textContent=e.format?e.format(t):t,pu(l)};u(Number(l.value)),l.addEventListener(`input`,()=>{let t=Number(l.value);n[e.key]=t,u(t),r(e.key,t,o)}),c.appendChild(l),i.set(e.key,e=>{l.value=e,u(Number(e))}),a.set(e.key,{row:c,input:l})}if(e.type===`toggle`){c.classList.add(`row--inline`),c.appendChild(fu(`label`,`row__label`,e.label));let t=fu(`label`,`switch`),s=fu(`input`);s.type=`checkbox`,s.checked=!!n[e.key],t.appendChild(s),t.appendChild(fu(`i`)),c.appendChild(t),s.addEventListener(`change`,()=>{n[e.key]=s.checked,r(e.key,s.checked,o)}),i.set(e.key,e=>{s.checked=!!e}),a.set(e.key,{row:c,input:s})}if(e.type===`select`){c.appendChild(fu(`label`,`row__label`,e.label));let t=fu(`select`,`select`);for(let n of e.options){let e=fu(`option`,null,n.label);e.value=n.v,t.appendChild(e)}t.value=n[e.key],t.addEventListener(`change`,()=>{n[e.key]=t.value,r(e.key,t.value,o)}),c.appendChild(t),i.set(e.key,e=>{t.value=e}),a.set(e.key,{row:c,input:t})}if(e.hint){let t=fu(`p`,`row__hint`,e.hint);c.appendChild(t)}t.appendChild(c)}e.appendChild(t)}return{set(e,t){n[e]=t,i.get(e)?.(t)},setDisabled(e,t,n=``){for(let r of e){let e=a.get(r);e&&(e.input.disabled=t,e.row.classList.toggle(`is-disabled`,t),e.row.title=t?n:``)}},values:n}}function hu(){let e=document.getElementById(`statusbar`),t=document.getElementById(`statPoints`),n=document.getElementById(`statSize`),r=document.getElementById(`statTime`),i=document.getElementById(`statFps`),a=document.getElementById(`toast`),o=document.getElementById(`toastBar`),s=a.querySelector(`.toast__bar`),c=document.getElementById(`toastText`),l=0;return{showBar(){e.classList.add(`is-on`)},setPoints(e){t.innerHTML=`<b>${e.toLocaleString(`zh-CN`)}</b> 点`},setSize(e,t){n.textContent=`${e}×${t}`},setTime(e){r.textContent=`${e} ms`},setFps(e){i.innerHTML=`<b>${e}</b> FPS`},show(e,t=null){clearTimeout(l),a.hidden=!1,a.classList.remove(`is-error`),c.textContent=e,t==null?(s.classList.add(`is-indeterminate`),o.style.width=`35%`):(s.classList.remove(`is-indeterminate`),o.style.width=`${Math.max(0,Math.min(1,t))*100}%`)},done(e,t=1400){clearTimeout(l),a.hidden=!1,a.classList.remove(`is-error`),s.classList.remove(`is-indeterminate`),o.style.width=`100%`,c.textContent=e,l=setTimeout(()=>{a.hidden=!0},t)},error(e){clearTimeout(l),a.hidden=!1,a.classList.add(`is-error`),s.classList.remove(`is-indeterminate`),o.style.width=`100%`,c.textContent=e,l=setTimeout(()=>{a.hidden=!0},8e3)},hide(){clearTimeout(l),a.hidden=!0}}}function gu(){let e=document.getElementById(`engineBadge`),t=e.querySelector(`.engine__dot`),n=e.querySelector(`.engine__text`);return{set(e,r){t.dataset.state=e,n.textContent=r,n.title=r}}}function _u(e){let t=document.getElementById(`dropzone`),n=document.getElementById(`pickBtn`),r=document.getElementById(`fileInput`),i=document.getElementById(`samples`);for(let t of m){let n=document.createElement(`button`);n.type=`button`,n.className=`sample`,n.title=`示例：${t.name}`;let r=h(t.id,128);r.style.width=`100%`,r.style.height=`100%`,n.appendChild(r);let a=document.createElement(`span`);a.textContent=t.name,n.appendChild(a),n.addEventListener(`click`,async()=>{e(await g(t.id,768),`示例·${t.name}`)}),i.appendChild(n)}n.addEventListener(`click`,()=>r.click()),r.addEventListener(`change`,()=>{let t=r.files?.[0];t&&e(t,t.name),r.value=``});let a=0,o=e=>Array.from(e.dataTransfer?.types??[]).includes(`Files`);return window.addEventListener(`dragenter`,e=>{o(e)&&(e.preventDefault(),a++,t.classList.add(`is-over`),t.hidden=!1)}),window.addEventListener(`dragover`,e=>{o(e)&&e.preventDefault()}),window.addEventListener(`dragleave`,e=>{o(e)&&(a=Math.max(0,a-1),a===0&&t.classList.remove(`is-over`))}),window.addEventListener(`drop`,n=>{if(!o(n))return;n.preventDefault(),a=0,t.classList.remove(`is-over`);let r=Array.from(n.dataTransfer.files).find(e=>e.type.startsWith(`image/`));r&&e(r,r.name)}),window.addEventListener(`paste`,t=>{let n=Array.from(t.clipboardData?.items??[]).find(e=>e.type.startsWith(`image/`));if(!n)return;let r=n.getAsFile();r&&e(r,`剪贴板图片`)}),{hide(){t.hidden=!0},show(){t.hidden=!1},note(e){document.getElementById(`engineNote`).textContent=e}}}var vu=o(),Z={mode:`browser`,modelKey:n,image:null,preparedBlob:null,source:null,cloud:null,name:`pointcloud`,busy:!1,engineReady:!1,localModels:null},Q=hu(),$=gu(),yu=new du(document.getElementById(`stage`)),bu=new _;yu.onFps=e=>Q.setFps(e),yu.applyParams(vu);var xu=mu(document.getElementById(`paramGroups`),a,vu,Zu),Su=_u(Gu),Cu=j(Ku),wu=new Set([`gen3d`,`mv`]),Tu=!1,Eu=document.getElementById(`modeSel`),Du=document.getElementById(`modelSel`),Ou=document.getElementById(`modelRow`);for(let[e,n]of Object.entries(t)){let t=document.createElement(`option`);t.value=e,t.textContent=`${n.label}（${n.params}）`,Du.appendChild(t)}Du.value=Z.modelKey;async function ku(t){try{let n=await fetch(`${e}${t}/config.json`,{cache:`no-store`});return n.ok?(n.headers.get(`content-type`)||``).includes(`json`):!1}catch{return!1}}async function Au(){let e={};for(let[n,r]of Object.entries(t)){let t=await ku(r.id);e[n]=t;let i=Du.querySelector(`option[value="${n}"]`);i&&(i.textContent=`${r.label}（${r.params}）${t?` · 已就绪`:` · 需下载`}`)}return e}Eu.addEventListener(`change`,async()=>{Z.mode=Eu.value,ju(),Z.source=null,await Hu(),Z.image&&qu()});function ju(){let e=Z.mode===`browser`,t=wu.has(Z.mode);Ou.style.display=e?``:`none`,xu.setDisabled(c,!e,t?`生成式 3D 直接输出完整三维形体，与深度图转换相关的参数不参与计算`:`高精度模式使用 MoGe 预测的真实内参与米制点图，此参数不参与计算`),Cu.show(Z.mode===`mv`),document.getElementById(`dropSamples`).hidden=Z.mode===`mv`,!Tu&&vu.solidMode!==t&&(vu.solidMode=t,xu.set(`solidMode`,t),yu.applyParams(vu))}Du.addEventListener(`change`,async()=>{Z.modelKey=Du.value,Z.engineReady=!1,Z.source=null,$.set(`idle`,`模型已切换，下次推理时加载`),Z.image&&qu()});var Mu=document.getElementById(`panel`);document.getElementById(`panelToggle`).addEventListener(`click`,()=>{let e=Mu.dataset.collapsed===`true`;Mu.dataset.collapsed=String(!e)});var Nu=document.getElementById(`exportPly`),Pu=document.getElementById(`snapshot`),Fu=document.getElementById(`replay`),Iu=document.getElementById(`resetView`),Lu=document.getElementById(`plyFormat`),Ru=document.getElementById(`keepScale`);Nu.addEventListener(`click`,ed),Pu.addEventListener(`click`,td),Fu.addEventListener(`click`,()=>yu.replay()),Iu.addEventListener(`click`,()=>yu.resetView()),Lu.addEventListener(`change`,$u);var zu=e=>`${e}要在你自己的电脑上跑一个本机服务（Python + GPU），纯网页版提供不了。启用方法：终端里跑 server\\start.ps1，再跑 web 目录的 npm run dev，打开 http://127.0.0.1:5173 —— 后端一起来，这里展开下拉就会自动解除标注。不想装的话用「⚡ 浏览器」模式，它完全在本页面里跑。`,Bu=[`server`,`gen3d`,`mv`];async function Vu(){let e=!!await b(1500);for(let t of Bu){let n=Eu.querySelector(`option[value="${t}"]`);n&&(n.dataset.label||(n.dataset.label=n.textContent),n.disabled=!1,n.textContent=e?n.dataset.label:`${n.dataset.label} · 需本机运行`)}return e}async function Hu(){if(Z.mode===`mv`){$.set(`loading`,`正在探测本机后端…`);let e=await O();if(!e?.ok){$.set(`error`,`需要本机后端`),Su.note(zu(`多视图生成`));return}if(e.weightsCached===!1){$.set(`idle`,`模型未下载（约 4.9GB）`),Su.note(`多视图生成：Hunyuan3D 权重还没下载（约 4.9GB），首次使用需联网拉取，可能很慢`);return}$.set(`ready`,`Hunyuan3D-2mv · ${e.device??`cuda`}`),Su.note(`多视图：正面必填，另外最多再给三张（左/背/右）。给得越多，背面越忠实于你的原图`),e.loaded||($.set(`loading`,`正在预热模型…`),k().then(e=>{$.set(e?.ok?`ready`:`error`,e?.ok?`Hunyuan3D-2mv · ${e.device??``}`.trim():`预热失败，首图会较慢`)}));return}if(Z.mode===`gen3d`){$.set(`loading`,`正在探测本机后端…`);let e=await T();if(e?.ok){let t=e.engine===`triposr`?`TripoSR`:`Hunyuan3D`,n=e.engine===`triposr`?`1.4GB`:`4.9GB`;$.set(`ready`,`${t} · ${e.device??`cuda`}`),e.weightsCached===!1?($.set(`idle`,`模型未下载（约 ${n}）`),Su.note(`生成式 3D：${t} 权重还没下载（约 ${n}），首次使用需联网拉取，可能很慢`)):(Su.note(`生成式 3D 就绪 · ${t} · 一张图生成完整 360° 形体，背面由模型补全（约 12 秒）。想让背面更贴合原作，改用「🎭 多视图」把背面图也给它。`),e.loaded||($.set(`loading`,`正在预热模型…`),w().then(e=>{$.set(e?.ok?`ready`:`error`,e?.ok?`${t} · ${e.device??``}`.trim():`预热失败，首图会较慢`)})))}else $.set(`error`,`需要本机后端`),Su.note(zu(`生成式 3D`));return}if(Z.mode===`server`){$.set(`loading`,`正在探测本机后端…`);let e=await b();if(e?.ok&&e.weightsCached===!1){$.set(`idle`,`模型未下载（约 1.2GB）`),Su.note(`高精度模式：MoGe 权重还没下载（约 1.2GB），首次使用需联网拉取，可能很慢`);return}e?.ok?($.set(`ready`,`${e.model??`MoGe`} · ${e.device??`cuda`}`),Su.note(`高精度模式就绪 · ${e.gpu??e.device??``}`.trim()),e.loaded||($.set(`loading`,`正在预热模型…`),y().then(e=>{$.set(e?.ok?`ready`:`error`,e?.ok?`${e.model??`MoGe`} · ${e.device??``}`.trim():`预热失败，首图会较慢`)}))):($.set(`error`,`需要本机后端`),Su.note(zu(`高精度模式`)));return}if(Z.engineReady&&bu.backend){let e=bu.backend;$.set(`ready`,`${e.device.toUpperCase()} · ${e.dtype}`)}else{let e=t[Z.modelKey];$.set(`idle`,Z.localModels?.[Z.modelKey]?`未加载（本地已就绪）`:`未加载（首次约 ${e.sizeMB.fp16}MB）`)}}async function Uu(){if(!navigator.gpu)return`WebGPU 不可用，将用 CPU（WASM）推理`;try{let e=await navigator.gpu.requestAdapter();return e?e.features?.has(`shader-f16`)?`WebGPU 就绪（fp16）`:`WebGPU 就绪（fp32）`:`拿不到 WebGPU 适配器，将用 CPU 推理`}catch{return`WebGPU 探测失败，将用 CPU 推理`}}async function Wu(){ju();let[e,n,r]=await Promise.all([Uu(),Au(),Vu()]);Z.localModels=n,Su.note([e,n[Z.modelKey]?`模型已本地就绪，无需联网`:`模型未预下载，首次使用需联网拉取约 ${t[Z.modelKey].sizeMB.fp16}MB（建议先跑 npm run fetch-model）`,r?null:`另外三种模式需要在本机跑 Python + GPU 服务，线上版提供不了`].filter(Boolean).join(` · `)),await Hu()}Eu.addEventListener(`mousedown`,()=>{Vu()}),Eu.addEventListener(`focus`,()=>{Vu()});async function Gu(e,t=`pointcloud`){if(!Z.busy){if(Z.mode===`mv`){Cu.accept(e);return}Z.name=t.replace(/\.[^.]+$/,``)||`pointcloud`;try{Z.busy=!0,Q.show(`正在解码图片…`);let t=await p(e,r);Z.image=t,Z.preparedBlob=await f(t.canvas),Q.setSize(t.width,t.height),await Ju()}catch(e){console.error(e),Q.error(String(e?.message??e))}finally{Z.busy=!1}}}async function Ku(e){if(!Z.busy)try{Z.busy=!0;let t=Object.keys(e).length;Q.show(`正在用 ${t} 张视图生成 3D 形体（约 40 秒）…`);let n=performance.now(),r=await A(e,{points:Math.max(6e5,vu.targetPoints)});Z.name=`multiview`,Z.image=null,Z.preparedBlob=null,Z.source={kind:`cloud`,...r},$.set(`ready`,`Hunyuan3D-2mv · ${r.meta?.device??`cuda`}`),Q.show(`正在生成点云…`),Yu(),Su.hide(),Q.showBar(),Q.setTime(Math.round(performance.now()-n));let i=r.meta?.warnings??[];i.length?(console.warn(`[多视图] 输入有问题：
`+i.join(`
`)),Q.error(i[0]+(i.length>1?`（还有 ${i.length-1} 条，见控制台）`:``))):Q.done(`完成 · ${Z.cloud.count.toLocaleString(`zh-CN`)} 点 · 用了 ${(r.meta?.viewsUsed??[]).length||t} 张视图`),yu.replay();for(let e of[Nu,Pu,Fu,Iu])e.disabled=!1;$u()}catch(e){console.error(e),Q.error(String(e?.message??e))}finally{Z.busy=!1}}async function qu(){if(!(Z.busy||!Z.image))try{Z.busy=!0,await Ju()}catch(e){console.error(e),Q.error(String(e?.message??e))}finally{Z.busy=!1}}async function Ju(){let e=performance.now();if(Z.mode===`gen3d`){Q.show(`正在生成 3D 形体（含背面补全，约 10–20 秒）…`);let e=await ee(Z.preparedBlob,{points:Math.max(6e5,vu.targetPoints)});Z.source={kind:`cloud`,...e},$.set(`ready`,`TripoSR · ${e.meta?.device??`cuda`}`)}else if(Z.mode===`server`){Q.show(`正在调用本机后端…`);let e=await S(Z.preparedBlob,{maxSide:r});if(e.width!==Z.image.width||e.height!==Z.image.height)throw Error(`后端返回 ${e.width}×${e.height}，与前端 ${Z.image.width}×${Z.image.height} 不一致，颜色会错位`);Z.source={kind:`pointmap`,...e},$.set(`ready`,`${e.meta?.model??`MoGe`} · ${e.meta?.device??`cuda`}`)}else{if(!Z.engineReady){$.set(`loading`,`正在加载模型…`),await bu.load(Z.modelKey,Qu),Z.engineReady=!0;let e=bu.backend;$.set(`ready`,`${e.device.toUpperCase()} · ${e.dtype}`)}Q.show(`正在估计深度…`),Z.source={kind:`depth`,...await bu.infer(Z.image)}}Q.show(`正在生成点云…`),Yu(),Su.hide(),Q.showBar(),Q.setTime(Math.round(performance.now()-e));let t=Z.source?.meta?.warnings??[];t.length?(console.warn(`[生成式] 输入有问题：
`+t.join(`
`)),Q.error(t[0])):Q.done(`完成 · ${Z.cloud.count.toLocaleString(`zh-CN`)} 点`),yu.replay();for(let e of[Nu,Pu,Fu,Iu])e.disabled=!1;$u()}function Yu(e=!1){if(!Z.source||Z.source.kind!==`cloud`&&!Z.image)return;let t=performance.now(),n=Z.source.kind===`cloud`?N({positions:Z.source.positions,colors:Z.source.colors,normals:Z.source.normals,ao:Z.source.ao,count:Z.source.count,options:vu}):Z.source.kind===`pointmap`?re({points:Z.source.points,mask:Z.source.mask,width:Z.source.width,height:Z.source.height,rgba:Z.image.data,options:vu}):M({depth:Z.source.depth,width:Z.source.width,height:Z.source.height,rgba:Z.image.data,options:vu});Z.cloud=n,yu.setCloud(n),yu.applyParams(vu),e?yu.replay():yu.cloud.snapToEnd(),Q.setPoints(n.count),console.debug(`[点云] ${n.count} 点 · 步长 ${n.stats.step} · 边缘剔除 ${n.stats.culledEdge} · 远景剔除 ${n.stats.culledSky} · ${Math.round(performance.now()-t)}ms`),$u()}var Xu=0;function Zu(e,t,n){e===`solidMode`&&(Tu=!0),n?(clearTimeout(Xu),Xu=setTimeout(()=>{try{Yu()}catch(e){Q.error(String(e?.message??e))}},130)):yu.applyParams(vu)}function Qu(e){if(e.status===`progress`&&e.total){let t=e.loaded/e.total;Q.show(`正在下载模型 ${e.file??``} ${(e.loaded/1048576).toFixed(1)} / ${(e.total/1048576).toFixed(1)} MB`,t),$.set(`loading`,`下载中 ${Math.round(t*100)}%`)}else e.status===`init`||e.status===`initiate`?Q.show(e.message??`正在准备模型…`):e.status===`fallback`?(console.warn(e.message),Q.show(e.message)):(e.status===`ready`||e.status===`done`)&&Q.show(`模型就绪`)}function $u(){Z.cloud&&(Nu.textContent=`导出 PLY（${F(se(Z.cloud.count,Lu.value))}）`)}function ed(){if(Z.cloud)try{Q.show(`正在打包 PLY…`);let e=P(Z.cloud,{format:Lu.value,keepScale:Ru.checked});ce(e,le(Z.name,`ply`)),Q.done(`已导出 ${F(e.size)}`)}catch(e){console.error(e),Q.error(String(e?.message??e))}}async function td(){try{let e=await yu.snapshot();if(!e)throw Error(`截图失败`);ce(e,le(Z.name,`png`)),Q.done(`已保存截图`)}catch(e){Q.error(String(e?.message??e))}}Wu(),window.__pcs={state:Z,params:vu,viewer:yu,engine:bu,rebuildCloud:Yu};